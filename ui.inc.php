...
function left_bar(){?>
  <div class="pure-u-1-6">
    ...
    <p><img src="<?=route_img("octocat.png")?>"></img> <a href="">source code</a></p>
...
function right_bar(){?>
  <div class="pure-u-1-6">
    <div class="col">
    <h1>About</h1>
    <p>Rice husk, the outer shell of a grain of rice, is produced worldwide and generally considered a waste material. The particular physical properties of rice husk do not lend it to many applications. It is too fluffy to transport, too widespread to charge for, and makes a poor fuel source.</p>
